...
class Builder
{
     ...
     * @var array
     */
    public $bindings = ['select' => [], 'from' => [], 'join' => [], 'where' => [], 'having' => [], 'order' => [], 'union' => []];
    /**
    ...
    public function toRawSql()
    {
        ...
        return $this->grammar->substituteBindingsIntoRawSql($this->toSql(), $bindings);
    }
    /**
    ...
    public function update(array $values)
    {
        ...
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['values'], 'keys' => compact(['values']), 'variadic' => ''], function (array $values) use($__function__, $__method__) {
    ...
    public function delete($id = null)
    {
        $__function__ = __FUNCTION__;
        $__method__ = __METHOD__;
        return self::__proxyCall(__CLASS__, __FUNCTION__, ['order' => ['id'], 'keys' => compact(['id']), 'variadic' => ''], function ($id = null) use($__function__, $__method__) {
    ...
    {
        return $value instanceof static || $value instanceof ModelBuilder || $value instanceof Relation || $value instanceof Closure;
    }
    /**
    ...
    protected function assertBinding($value, $column = '', int $limit = 0)
    {
        if ($limit === 0) {
            if (is_array($value)) {
                throw new InvalidBindingException(sprintf('The value of column %s is invalid.', (string) $column));
            }
            return $value;
        }
        if (count($value) !== $limit) {
            throw new InvalidBindingException(sprintf('The value length of column %s is not equal with %d.', (string) $column, $limit));
        }
        return $value;
    }
}