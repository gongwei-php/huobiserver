...
<template>
  <div class="switch-wrapper">
    ...
    }" aria-checked="false" class="switch-inner" role="switch" type="button" :disabled="disabled || loading"
      @click="handleChange">
      <span :class="{
        'translate-x-0': !modelValue,
        'translate-x-5': modelValue,
      }" aria-hidden="true" class="switch-indicator">
        <svg v-if="loading" class="animate-spin" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <circle class="opacity-0" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
          <path class="opacity-30"
